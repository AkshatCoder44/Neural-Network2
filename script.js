...
let w1_1 = Math.random();
let w1_2 = Math.random();
let b1 = Math.random();

let w2_1 = Math.random();
let w2_2 = Math.random();
let b2 = Math.random();
...
for (let i = 0; i < 1000; i++) {
  let z1 = w1_1 * input1 + w1_2 * input2 + b1;
  let h1 = sigmoid(z1);

  let z2 = w2_1 * input1 + w2_2 * input2 + b2;
  let h2 = sigmoid(z2);
...
let h1_final = sigmoid(w1_1 * input1 + w1_2 * input2 + b1);
let h2_final = sigmoid(w2_1 * input1 + w2_2 * input2 + b2);
